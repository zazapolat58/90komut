...
const mutelog = message.guild.channels.cache.find(c => c.id === '799759265786626128')//Mute log
const muterol = message.guild.roles.cache.find(r => r.id === '799756808393850910')//Muteli rolü
