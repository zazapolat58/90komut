...
const mutelog = message.guild.channels.cache.find(c => c.id === '817333894382485524')//Mute logu
const muterol = message.guild.roles.cache.find(r => r.id === '817333137734369301')//Muteli rolü
